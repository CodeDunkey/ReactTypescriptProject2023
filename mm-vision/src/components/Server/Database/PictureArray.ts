...
export const pictureList: Picture[] = [
    {id: 1, src: nySlidePict1, pictureSize: "cover"},
    {id: 2, src: nySlidePict2, pictureSize: "cover"},
    {id: 3, src: nySlidePict3, pictureSize: "cover"},
    {id: 4, src: BærbareComputere, pictureSize: "cover"},
    {id: 5, src: CartLogo, pictureSize: "cover"},
    {id: 6, src: CorsairHydroSeries, pictureSize: "cover"},
    {id: 7, src: LoadingIconSmall, pictureSize: "cover"},
    {id: 8, src: VisionGamingSeries, pictureSize: "cover"},
    {id: 9, src: iconCheck, pictureSize: "cover"},
    {id: 10, src: mmVisionLogo, pictureSize: "cover"},
    {id: 11, src: spinnerOfDots, pictureSize: "cover"},
]